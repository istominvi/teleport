...
export const metadata: Metadata = {
  ...
  title: {
    default: "TelePort™ — Высокоскоростной сетевой шлюз. Современные протоколы. Оплата картой РФ.",
  ...
  openGraph: {
    ...
    siteName: "TelePort™",
    title: "TelePort™ — Высокоскоростной сетевой шлюз. Современные протоколы. Оплата картой РФ.",
    description: "Высокоскоростной сетевой шлюз для безопасной передачи данных. Защита соединения по современным протоколам. Стабильный доступ к рабочим и личным ресурсам. Оплата картой РФ.",
    images: [
      {
        url: "/og-image.png",
