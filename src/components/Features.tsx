...
const features = [
  {
    ...
    description: 'Принимаем карты любых российских банков и СБП. Официальная оплата услуг связи, прозрачные условия.',
  ...
  },
  {
    ...
    description: 'Удобное приложение. Единый профиль подключения для всех платформ. Работает на iOS, Android и Windows.',
  ...
  },
  {
    ...
    description: 'Автоматический выбор наилучшего узла связи для стабилизации соединения и улучшения отклика в играх.',
    color: 'from-indigo-400 to-violet-500',
  },
  {
    icon: ShieldOff,
    title: 'Защита данных',
    description: 'Обеспечиваем защиту передаваемых пакетов данных без их анализа. Безопасность уровня Enterprise для работы в любых Wi-Fi сетях.',
