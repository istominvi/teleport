...
const features = [
  ...
  },
  {
    ...
    description: 'Смотрите стримы и видео в 4K без потери скорости.',
    color: 'from-yellow-400 to-orange-500',
  },
  {
    icon: Smartphone,
    title: 'Простая настройка',
    description: 'Клиент v2RayTun. Одна ссылка-ключ для подключения. Работает на iOS и Android и Windows.',
  ...
  },
  {
    icon: Globe,
    title: 'Смена страны',
    description: 'Подключайтесь к серверам в разных странах для стабильного доступа к мировым медиа и игровым серверам.',
