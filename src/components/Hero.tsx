  ...
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-4 pt-20 text-center sm:px-6 lg:px-8">
      ...
      >
        ...
        Современный приватный протокол на базе VLESS. Обеспечивает высокую скорость и стабильное соединение для игр, стриминга и глобальных медиа. Оплата любой картой РФ и СБП.
        </p>
